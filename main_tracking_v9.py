...
#这是用棋盘格标定出来的
# DEVICE_THETA = {
#     1: {"theta_vertical": 0.0000, "theta_horizontal": 33.85},  # Layer 1 cam1
...
#     8: {"theta_vertical": 9.5000, "theta_horizontal": 0.0},        # Layer 2 cam3
...
#     17: {"theta_vertical": 28.5000, "theta_horizontal": 18.8883},  # Layer 4 cam2
...
# }
DEVICE_THETA = {
    1: {"theta_vertical": 0.0, "theta_horizontal": 32.7},  # Layer 1 cam1
    2: {"theta_vertical": 0.0, "theta_horizontal": 16.4},  # Layer 1 cam2
    3: {"theta_vertical": 0.0, "theta_horizontal": 0.0},  # Layer 1 cam3
    4: {"theta_vertical": 0.0, "theta_horizontal": 343.6},  # Layer 1 cam4
    5: {"theta_vertical": 0.0, "theta_horizontal": 327.3},  # Layer 1 cam5
    6: {"theta_vertical": 9.5, "theta_horizontal": 34.4},  # Layer 2 cam1
    7: {"theta_vertical": 9.5, "theta_horizontal": 17.2},  # Layer 2 cam2
    8: {"theta_vertical": 9.5, "theta_horizontal": 0.1},  # Layer 2 cam3
    9: {"theta_vertical": 9.5, "theta_horizontal": 342.9},  # Layer 2 cam4
    10: {"theta_vertical": 9.5, "theta_horizontal": 325.8},  # Layer 2 cam5
    11: {"theta_vertical": 19.0, "theta_horizontal": 35.3},  # Layer 3 cam1
    12: {"theta_vertical": 19.0, "theta_horizontal": 18.1},  # Layer 3 cam2
    13: {"theta_vertical": 19.0, "theta_horizontal": 1.0},  # Layer 3 cam3
    14: {"theta_vertical": 19.0, "theta_horizontal": 343.8},  # Layer 3 cam4
    15: {"theta_vertical": 19.0, "theta_horizontal": 326.7},  # Layer 3 cam5
    16: {"theta_vertical": 28.5, "theta_horizontal": 36.8},  # Layer 4 cam1
    17: {"theta_vertical": 28.5, "theta_horizontal": 18.8},  # Layer 4 cam2
    18: {"theta_vertical": 28.5, "theta_horizontal": 0.8},  # Layer 4 cam3
    19: {"theta_vertical": 28.5, "theta_horizontal": 342.8},  # Layer 4 cam4
    20: {"theta_vertical": 28.5, "theta_horizontal": 324.8},  # Layer 4 cam5
    21: {"theta_vertical": 38.0, "theta_horizontal": 38.7},  # Layer 5 cam1
    22: {"theta_vertical": 38.0, "theta_horizontal": 19.7},  # Layer 5 cam2
    23: {"theta_vertical": 38.0, "theta_horizontal": 0.8},  # Layer 5 cam3
    24: {"theta_vertical": 38.0, "theta_horizontal": 341.8},  # Layer 5 cam4
    25: {"theta_vertical": 38.0, "theta_horizontal": 322.9},  # Layer 5 cam5
    26: {"theta_vertical": 47.5, "theta_horizontal": 41.8},  # Layer 6 cam1
    27: {"theta_vertical": 47.5, "theta_horizontal": 21.8},  # Layer 6 cam2
    28: {"theta_vertical": 47.5, "theta_horizontal": 1.8},  # Layer 6 cam3
    29: {"theta_vertical": 47.5, "theta_horizontal": 341.8},  # Layer 6 cam4
    30: {"theta_vertical": 47.5, "theta_horizontal": 321.8},  # Layer 6 cam5
    31: {"theta_vertical": 57.0, "theta_horizontal": 45.2},  # Layer 7 cam1
    32: {"theta_vertical": 57.0, "theta_horizontal": 24.0},  # Layer 7 cam2
    33: {"theta_vertical": 57.0, "theta_horizontal": 2.9},  # Layer 7 cam3
    34: {"theta_vertical": 57.0, "theta_horizontal": 341.7},  # Layer 7 cam4
    35: {"theta_vertical": 57.0, "theta_horizontal": 320.5},  # Layer 7 cam5
    36: {"theta_vertical": 66.5, "theta_horizontal": 47.9},  # Layer 8 cam1
    37: {"theta_vertical": 66.5, "theta_horizontal": 25.4},  # Layer 8 cam2
    38: {"theta_vertical": 66.5, "theta_horizontal": 2.9},  # Layer 8 cam3
    39: {"theta_vertical": 66.5, "theta_horizontal": 340.4},  # Layer 8 cam4
    40: {"theta_vertical": 66.5, "theta_horizontal": 317.9},  # Layer 8 cam5
    41: {"theta_vertical": 76.0, "theta_horizontal": 61.7},  # Layer 9 cam1
    42: {"theta_vertical": 76.0, "theta_horizontal": 37.7},  # Layer 9 cam2
    43: {"theta_vertical": 76.0, "theta_horizontal": 13.7},  # Layer 9 cam3
    44: {"theta_vertical": 76.0, "theta_horizontal": 349.7},  # Layer 9 cam4
    45: {"theta_vertical": 76.0, "theta_horizontal": 325.7},  # Layer 9 cam5
}
# ==========================================
# 硬件映射表 (不变)
# ========================================== 
